      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white dark:bg-[#202020] p-6 rounded-lg border border-slate-200/70 dark:border-white/10 relative overflow-hidden">
            ...
            <div className="relative flex flex-col items-center mt-8">
              ...
              <h3 className="font-bold text-lg text-[var(--dash-text)]">{name}</h3>
              ...
              <div className="w-full space-y-3 text-sm">
                <div className="flex justify-between items-center">
                  <span className="text-[var(--dash-text-soft)]">Status Akun</span>
                  <span className="text-purple-600 font-medium flex items-center gap-1">
                    Aktif
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[var(--dash-text-soft)]">Email Terverifikasi</span>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="dash-card">
            <h2 className="text-lg font-bold text-[var(--dash-text)] mb-6 flex items-center gap-2">
              <User className="w-5 h-5 text-purple-500" />
              Informasi Pribadi
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <label className="text-sm font-medium text-[var(--dash-text)] dark:text-zinc-300 mb-1 block">Nama Lengkap</label>
                <input
                  type="text"
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  className="w-full h-11 px-4 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-[#202020] text-[var(--dash-text)] focus:outline-none focus:ring-2 focus:ring-purple-500/25 focus:border-purple-400 transition-all"
                  placeholder="Masukkan nama lengkap"
                />
              </div>
              <div className="md:col-span-2">
                <label className="text-sm font-medium text-[var(--dash-text)] dark:text-zinc-300 mb-1 block">Alamat Email</label>
                <input
                  type="email"
          ...
          <div className="dash-card">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm font-medium text-[var(--dash-text)] dark:text-zinc-300 mb-1 block">Kata Sandi Saat Ini</label>
                <input
                  type="password"
                  value={password}
              ...
              <div>
                <label className="text-sm font-medium text-[var(--dash-text)] dark:text-zinc-300 mb-1 block">Kata Sandi Baru</label>
                <input
                  type="password"
                  value={newPassword}
          ...
          <div className="flex justify-end gap-3">
            <button className="px-5 py-2.5 bg-white dark:bg-[#202020] border border-slate-200 dark:border-white/10 text-[var(--dash-text)] dark:text-zinc-300 font-medium rounded-md hover:bg-slate-50 dark:hover:bg-[#2f2f2f] transition-colors text-sm">
              Batal
            </button>
