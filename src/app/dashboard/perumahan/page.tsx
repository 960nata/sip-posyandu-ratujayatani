            ...
            <div>
              {role !== 'OPERATOR_DESA' && (
                <button 
                  ...
                  className="p-2 bg-emerald-50 dark:bg-emerald-955/30 text-emerald-600 dark:text-emerald-400 rounded-full hover:bg-emerald-100 dark:hover:bg-emerald-955/50 transition-colors"
