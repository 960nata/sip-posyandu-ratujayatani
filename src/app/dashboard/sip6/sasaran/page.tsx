  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[var(--dash-text)]">Sasaran Individu SIP 6</h1>
          <p className="text-[var(--dash-text-soft)] text-sm">Pencatatan kehadiran sasaran per individu</p>
        </div>
        <div className="flex items-center gap-2">
          <button className="flex items-center gap-2 bg-white dark:bg-[#202020] border border-slate-200 dark:border-white/10 rounded-md px-4 py-2.5 text-sm font-medium text-[var(--dash-text)] dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white dark:bg-[#202020] p-4 rounded-lg border border-slate-200 dark:border-white/10">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          <select className="bg-slate-50 dark:bg-[#2f2f2f]/50 border border-slate-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-sm font-medium text-[var(--dash-text)] dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-500/25 focus:border-purple-400 transition-all w-full md:w-auto">
            ...
            <tbody>
              {data.map((row) => (
                <tr key={row.id} className="border-b border-slate-200/70 dark:border-white/10 hover:bg-slate-50/50 dark:hover:bg-slate-700/20 transition-colors">
                  <td className="px-6 py-4 font-medium text-[var(--dash-text)] sticky left-0 bg-white dark:bg-[#202020] z-10">{row.nama}</td>
