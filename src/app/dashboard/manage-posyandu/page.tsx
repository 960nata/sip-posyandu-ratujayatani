      ...
      <AnimatePresence>
        {isDeletePosyanduModalOpen && selectedPosyandu && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} transition={{ duration: 0.3 }} className="relative bg-white dark:bg-zinc-800 rounded-xl shadow-xl w-full max-w-md p-6 border border-slate-200 dark:border-zinc-700">
              ...
              <p className="text-sm text-slate-600 dark:text-zinc-300 bg-rose-50 dark:bg-rose-900/20 border border-rose-100 dark:border-rose-800 rounded-xl p-3 mb-6">
