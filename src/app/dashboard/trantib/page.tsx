...
export default function TrantibPage() {
  ...
  useEffect(() => {
    ...
    const savedReports = localStorage.getItem('sip_trantib_reports')
    if (savedReports) {
      setReports(JSON.parse(savedReports))
    } else {
      setReports(defaultTrantibSeeds)
      localStorage.setItem('sip_trantib_reports', JSON.stringify(defaultTrantibSeeds))
    }
  ...
  const handleDelete = (id: string) => {
    if(confirm('Apakah Anda yakin ingin menghapus data ini?')) {
      ...
      setReports(updated)
      localStorage.setItem('sip_trantib_reports', JSON.stringify(updated))
    }
  }
