      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <motion.div
              className="bg-gradient-to-br from-purple-600 to-indigo-700 text-white p-8 rounded-2xl flex flex-col justify-between shadow-lg shadow-purple-900/10"
            ...
            >
              <div>
                <span className="text-xs font-bold tracking-widest uppercase text-purple-100 mb-2 block">
                  Indeks Pembangunan Manusia
                </span>
                <div className="flex items-baseline gap-2 mb-1">
                  <h3 className="text-5xl font-bold">0,705</h3>
                  <span className="text-purple-200 text-sm">IPM Indonesia</span>
                </div>
                <p className="text-purple-50 text-sm font-light mb-6">Peringkat 114 dari 199 Negara</p>
                
                <p className="text-sm text-purple-50 font-light leading-relaxed mb-6">
              ...
              <div className="grid grid-cols-3 gap-4 border-t border-white/10 pt-6">
                <div>
                  <p className="text-xs text-purple-200 mb-1">Indonesia</p>
                  <div className="w-full bg-white/10 h-1.5 rounded-full overflow-hidden">
                    <div className="bg-purple-400 h-full" style={{ width: "70.5%" }}></div>
                  </div>
                  <p className="text-sm font-bold mt-1">0.705</p>
                </div>
                <div>
                  <p className="text-xs text-purple-200 mb-1">Singapura</p>
                  <div className="w-full bg-white/10 h-1.5 rounded-full overflow-hidden">
                ...
                <div>
                  <p className="text-xs text-purple-200 mb-1">Jepang</p>
                  <div className="w-full bg-white/10 h-1.5 rounded-full overflow-hidden">
            ...
            {[
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow justify-between">
                  <div>
                    <div className="w-12 h-12 bg-purple-100 text-purple-600 rounded-xl flex items-center justify-center mb-4 text-xl">
                      <item.icon className="w-6 h-6" />
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="p-6 bg-purple-50 rounded-2xl border border-purple-100 relative">
                <div className="absolute -top-3 -left-3 w-8 h-8 bg-purple-500 text-white rounded-full flex items-center justify-center">
            ...
            <div className="space-y-4">
              ...
              {[
                ...
                <motion.div
                  key={idx}
                  className="flex gap-3 items-start p-3 bg-slate-50 rounded-lg hover:bg-purple-50/50 transition-colors"
                  initial={{ opacity: 0, x: 20 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.5, delay: idx * 0.1 }}
                  viewport={{ once: true }}
                >
                  <div className="flex-shrink-0 w-5 h-5 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center mt-0.5">
            ...
            {[
              ...
              { year: "2029", title: "Lampung Timur Data-Driven", desc: "100% desa terdaftar, semua keputusan kebijakan berbasis data posyandu yang valid" },
                ...
                >
                  {/* Line Segment */}
                  {idx < 4 && (
                    <div className="absolute left-1/2 top-1/2 w-0.5 bg-purple-100 -translate-x-1/2 hidden md:block z-0" style={{ height: "calc(100% + 3rem)" }} />
                  )}

                  {/* Dot */}
                  <div className="absolute left-1/2 top-1/2 w-4 h-4 bg-purple-500 rounded-full -translate-x-1/2 -translate-y-1/2 hidden md:block border-4 border-white shadow-sm z-10" />
