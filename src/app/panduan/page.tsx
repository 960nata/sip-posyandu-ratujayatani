...
import { Heart, ArrowRight, Building, Home, Briefcase, Lightbulb, Calendar, Image as ImageIcon, Flag, Medal, Pin, FileText, Circle, Shirt, Folder, Lock, Trash, Landmark, Clipboard } from "lucide-react";
        ...
        <section className="py-20 bg-slate-50 border-y border-slate-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {[
                { icon: ImageIcon, title: "Logo / Lambang", desc: "Identitas visual utama" },
