      ...
      {/* Sidebar */}
        ...
        >
            ...
            <div className="h-16 flex items-center justify-between px-6 border-b border-slate-50 dark:border-slate-800">
              ...
              <button 
                onClick={() => setSidebarOpen(false)}
                className="lg:hidden text-slate-500 hover:text-slate-700 dark:hover:text-white p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-4 border-t border-slate-50 dark:border-slate-800">
              <div className="flex items-center space-x-3 p-3 bg-slate-50 dark:bg-zinc-800/50 rounded-xl">
                ...
                <button 
                  ...
                  className="p-2 text-slate-400 hover:text-red-500 dark:hover:text-red-400 rounded-lg hover:bg-white dark:hover:bg-slate-800 shadow-sm transition-all"
                >
        ...
        <header className="h-16 bg-white/80 dark:bg-[#111827]/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 flex items-center justify-between px-6 sticky top-0 z-20 shadow-sm shadow-slate-100/50 dark:shadow-none">
          <div className="flex items-center space-x-4">
            <button
              ...
              className="lg:hidden text-slate-500 hover:text-slate-700 dark:hover:text-white p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
            >
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="p-2.5 text-slate-500 hover:text-slate-700 dark:hover:text-white rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
            ...
            <div className="relative" ref={notificationRef}>
              <button 
                ...
                className="relative p-2.5 text-slate-500 hover:text-slate-700 dark:hover:text-white rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
              >
              ...
              <AnimatePresence>
                {isNotificationOpen && (
                  <motion.div
                    ...
                    className="absolute right-[-50px] md:right-[-100px] mt-4 w-72 bg-white dark:bg-[#111827] rounded-xl shadow-lg border border-slate-100 dark:border-slate-800 py-2 z-50"
                  >
